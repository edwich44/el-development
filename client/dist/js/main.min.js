var video=document.getElementById("video-hero");if(video&&void 0!==video){var windowWidth=window.innerWidth,maxWidth=parseInt(video.dataset.maxWidth);if(windowWidth<=maxWidth){var sources=video.getElementsByTagName("source");sources[0].src="",video.setAttribute("poster","/images/web-design-software-solutions_snapshot_mobile.jpg"),video.load()}}
$((function(){$("#scroll-prompt").on("click",(function(t){t.preventDefault(),$("html, body").animate({scrollTop:$($(this).attr("href")).offset().top},500,"linear")}))}));
var elmToAddText=document.getElementById("scroll-text-services");if(elmToAddText&&void 0!==elmToAddText){var typewriter=new Typewriter(elmToAddText,{loop:!0,delay:75});typewriter.typeString("Web Design").pauseFor(900).deleteAll().typeString("Software Solutions").pauseFor(900).deleteAll().typeString("Contracting").pauseFor(900).deleteAll().start()}
