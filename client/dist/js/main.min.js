var video=document.getElementById("video-hero");if(video&&void 0!==video){var windowWidth=window.innerWidth,maxWidth=parseInt(video.dataset.maxWidth);if(windowWidth<=maxWidth){var sources=video.getElementsByTagName("source");sources[0].src="/images/video/Working-Space-mobile.mp4",video.load()}}
