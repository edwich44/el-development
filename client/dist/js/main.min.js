var video=document.getElementById("video-hero");if(video&&void 0!==video){var windowWidth=window.innerWidth,maxWidth=parseInt(video.dataset.maxWidth);if(windowWidth<=maxWidth){var sources=video.getElementsByTagName("source");sources[0].src="",video.setAttribute("poster","/images/working-space_snapshot_mobile.jpg"),video.load()}}
