class HailStone{constructor(){}getViews(){return getViews()}}function getViews(){var e=document.querySelectorAll("[data-hailstone-routing-view]");if(!e&&0!=e.length){var t=new RoutingService(new HttpClient);for(x=0;e.length>x;x++){var i=e[x],n=i.getAttribute("data-hailstone-routing-view");i.innerHTML=t.getView(n)}}}
class HttpClient{constructor(){this.request=new Request}get(t){return this.request.get(t)}}class Request{constructor(){var t=new XMLHttpRequest;this.xhr=t}get(t){xhttp.onreadystatechange=function(){if(4==this.readyState&&200==this.status)return this.responseText},this.xhr.open("GET",t,!0),this.xhr.send()}}
class RoutingService{constructor(t){this.httpClient=t}getView(t){return this.httpClient.get(t)}}
