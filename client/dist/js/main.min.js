var elmToAddText=document.getElementById("scroll-text-services");if(!elmToAddText||void 0!==elmToAddText||null!=elmToAddText){var typewriter=new Typewriter(elmToAddText,{loop:!0,delay:75});typewriter.typeString("Web Design").pauseFor(900).deleteAll().typeString("Software Solutions").pauseFor(900).deleteAll().typeString("Contracting").pauseFor(900).deleteAll().start()}
